@time @testset "MC: IsingModel Simulation" begin
    ...
    @test 0.05181   ≈ measured[:Magn].M2 |> std_error   atol=0.03
    ...
    @test 0.006907  ≈ measured[:Energy].E |> std_error  atol=0.004
    ...
    @test 0.0004317 ≈ measured[:Energy].e |> std_error  atol=0.0003
